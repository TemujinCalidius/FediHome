...
### Added
- **Point FediHome at your own AT Protocol server** (#449) — the Bluesky host was fixed at `bsky.social`. If you've moved your account to a PDS you run yourself you keep your handle, posts and followers, but the server address changes — and FediHome couldn't sign in at all. Set your own now; leave it blank and nothing changes.
